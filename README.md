...
- AI를 적극 활용한 개발 및 생산성 극대화(테스트, 프론트엔드 구현 등)
...
테스트 코드 작성, `Fixture` 기반 테스트 데이터 생성 등

반복적이고 시간이 많이 드는 작업은 AI가 맡고,
**핵심 설계, 구조 결정은 사람이 직접 수행하는 방식**으로 개발 속도를 크게 높였습니다.

<br>

또한 익숙하지 않았던 `React` 프론트엔드를 **AI를 적절히 활용해 문제를 분석하고 구현 방향을 잡아가며 구현했습니다.**
